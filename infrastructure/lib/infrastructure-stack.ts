    ...
    const distribution = new cloudfront.Distribution(this, 'MathTestDistribution', {
      defaultBehavior: {
        origin: new origins.OriginGroup({
          primaryOrigin: origins.S3BucketOrigin.withOriginAccessControl(mathTestBucket),
          fallbackOrigin: origins.S3BucketOrigin.withOriginAccessControl(mathTestBucket),
        }),
